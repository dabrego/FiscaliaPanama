...
<!-------------------------------------------------------------->
    ...
    <h1>Dashboard</h1>
    <h4><a href="{{ url('/index') }}">Crear Nueva Consulta</a></h4>
    <div class="btn-group btn-group-justified">
  <a href="{{ url('/') }}" class="btn btn-primary">Home</a>
  <a href="{{ url('/index') }}" class="btn btn-primary">Lista de Pacientes</a>
  <a href="{{ url('/index') }}" class="btn btn-primary">Registrar Paciente</a>
</div>
    <hr>
