...
<!-------------------------------------------------------------->
    ...
    <hr>
    <h5><a href="{{ url('/dashboard') }}">Dashboard</a><a href="{{ url('/showubicacion') }}">->Mantenimiento de Ubicación</a><label>->Crear nueva Ubicación</label></h5>
    <form method="post" action="/locaciones">
       ...
       <div class="form-group">
             ...
             <input type="text" name="corregimiento" class="form-control" placeholder="Corregimiento">
          </div> 
